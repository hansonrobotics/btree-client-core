...
Welcome to ``btree-client`` contributor's guide.
...
If you experience bugs or general issues with ``btree-client``, please have a look
...
You can help improve ``btree-client`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``btree-client`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``btree-client``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n btree-client python=3 six virtualenv pytest pytest-cov
    conda activate btree-client
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/btree-client.git
    cd btree-client
...
#. Install |pre-commit|_::
   ...
   ``btree-client`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/btree-client
.. _issue tracker: https://github.com/<USERNAME>/btree-client/issues
.. <-- end -->
